...
const Activities = () => {
  return (
    <div className=" flex flex-col justify-center items-center">
      <div className="bg-gradient-to-r from-[#bcbcfc] via-[#4464e4] to-[#7c54ac] flex flex-col gap-16 sm:gap-4 justify-center px-16 py-10 sm:px-4 sm:py-8 rounded-2xl shadow-xl">
        <h1 className="font-bold text-5xl sm:text-3xl text-[#fcac04]">Activities</h1>
